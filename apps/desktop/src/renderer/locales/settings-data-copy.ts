...
const SETTINGS_DATA_COPY = {
  ...
  en: {
    ...
    historyCleared: 'TextInput history cleared', historyClearedDetail: 'Sent prompt history was removed from this device.', selectCategory: 'Select at least one category',
    ...
    rows: {
      ...
      history: 'TextInput history', historyDetail: 'Previously sent prompts recalled with the Up and Down arrows are stored locally in the browser and persist across restarts. Clearing them cannot be undone.', localStorage: 'Local localStorage',
    },
