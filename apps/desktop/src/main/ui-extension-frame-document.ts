...
const clientApi=Object.freeze({theme:function(){return client('theme');},navigate:function(route){return client('navigate',{route:route});},notify:function(message){return client('notify',{message:message});},confirm:function(message){return client('confirm',{message:message});},writeClipboard:function(text){return client('clipboard.write',{text:text});},readArtifactText:function(){return client('artifact.readText');},readArtifactBinary:function(){return client('artifact.readBinary');}});
